    ...
    return (
        ...
        <main class="main" id="top">
              ...
              <div class="row flex-center">
                <div class="col-12 mb-10">
                  <div class="d-flex align-items-center flex-column">
                    <h1 class="fw-normal"> Makes you look awesome and unique from others</h1>
                    <h1 class="fs-4 fs-lg-8 fs-md-6 fw-bold"> The best place for online shopping for you</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section class="py-0 pt-7">
            <div class="container" className="{classes.containerFooter}" >
              <div class="row">
                ...
                <div class="col-sm-6 col-lg-auto ms-auto">
                  ...
                  <div class="row input-group-icon mb-5">
                    <div class="col-12"><input class="form-control input-box" type="email" placeholder="Enter Email" aria-label="email" />
                        </div>
                  </div>
                  ...
                  <p class="text-800"><svg class="feather feather-mail me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    </svg><span class="text-800">mdcr@gmail.com</span></p>
                </div>
              </div>
